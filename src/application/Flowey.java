...
public class Flowey {
	...
	private Image talking_1;

	private Image currImage;

	private GUIController gc;

	public Flowey(GUIController inGC){

		try {
			gc = inGC;
			talking_0 = new Image(new File("img/Flowey/0.png").toURI().toURL().toString(),252,264,false,false);
			talking_1 = new Image(new File("img/Flowey/1.png").toURI().toURL().toString(),252,264,false,false);
			currImage = talking_0;
